...
export function TaskDetail({ task, onBack, status }: TaskDetailProps) {
  ...
  const canSubmit = status === "todo" || status === "in_review";
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              <Badge 
                variant={status === "done" ? "done" : status === "in_review" ? "in_review" : "todo"}
        ...
        {canSubmit && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload an image or video to complete this task
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="caption"
                  placeholder="Add a caption to describe your submission..."
                  value={caption}
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <p className="text-sm text-green-600">
                  Congratulations! You&apos;ve earned {task.points} points for completing this task.
                </p>
              </div>
            </CardContent>
          </Card>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between text-xs text-muted-foreground">
                        ...
                        <Badge 
                          variant={submission.approved === true ? "done" : submission.approved === false ? "destructive" : "in_review"}
                        >
